...
# Django 서버의 실제 URL로 변경
DJANGO_ENDPOINT = "https://4c19-122-34-248-34.ngrok-free.app/"
#DJANGO_ENDPOINT = "https://a146-122-34-248-34.ngrok-free.app/visitlogs/nfc_entrance/"  

def send_to_django(nfc_uid):
    print(f"전송할 NFC UID: {nfc_uid}")  # 디버깅 출력 추가
    try:
        headers = {'Content-Type': 'application/json'}
        data = {'nfc_uid': nfc_uid}  # gym_id를 추가
