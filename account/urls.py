...
from .views import RegisterView, LoginView, ProfileUpdateView, home_view, profile_view, check_email_duplicate, update_nfc_view, verify_email, send_verification_code, profile_update_view
